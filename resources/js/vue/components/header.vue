...
<script setup>
    ...
    const navigation = [
        { name: 'Dashboard', href: '/vue#/vue', current: true },
        { name: 'Organizador', href: '/vue#/lista_organizador', current: false },
        { name: 'Asistente', href: '#', current: false },
        { name: 'Evento', href: '#', current: false },
        { name: 'Inscripción', href: '#', current: false },
    ]
